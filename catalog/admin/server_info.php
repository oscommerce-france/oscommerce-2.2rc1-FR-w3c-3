    ...
    <td width="100%" valign="top"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td><table border="0" summary="" cellspacing="0" cellpadding="3">
              <tr>
...
<?php
  if (function_exists('ob_start')) {
    ...
    $phpinfo = str_replace('<table ', '<table summary="" ', $phpinfo);
    ereg('<body>(.*)</body>', $phpinfo, $regs);
    echo '<table border="1" summary="" cellpadding="3" width="600" style="border: 0px; border-color: #000000;">' .
         '  <tr><td><a href="http://www.oscommerce.com"><img border="0" src="images/oscommerce.png" alt="osCommerce Online Merchant v2.2 RC1 W3C Valid FR"></a><h1 class="p"> ' . PROJECT_VERSION . '</h1></td>' . 
         '  </tr>' .
         '</table>';
    echo $regs[1];
  } else {
