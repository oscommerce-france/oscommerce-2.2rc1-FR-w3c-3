    ...
    <td width="100%" valign="top"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="100%"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
          <tr><td colspan="2"><?php echo tep_draw_form('goto', FILENAME_FILE_MANAGER, '', 'get'); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
            <td class="pageHeading"><?php echo HEADING_TITLE . '<br><span class="smallText">' . $current_path . '</span>'; ?></td>
            <td class="pageHeading" align="right"><?php echo tep_draw_separator('pixel_trans.gif', '1', HEADING_IMAGE_HEIGHT); ?></td>
            <td class="pageHeading" align="right"><?php echo tep_draw_pull_down_menu('goto', $goto_array, $current_path, 'onChange="this.form.submit();"'); ?></td></tr></table>
...
?>
      ...
      <tr><td colspan="2"><?php echo tep_draw_form('new_file', FILENAME_FILE_MANAGER, 'action=save'); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
...
?>
              <tr>
                <td colspan="7"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
                  <tr valign="top">
