...
?>
      ...
      <tr><td colspan="2"><?php echo tep_draw_form('newsletter', FILENAME_NEWSLETTERS, (isset($HTTP_GET_VARS['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . 'action=' . $form_action); if ($form_action == 'update') echo tep_draw_hidden_field('newsletter_id', $nID); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
...
?>
              <tr>
                <td colspan="6"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
