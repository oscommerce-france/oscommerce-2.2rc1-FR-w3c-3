...
?>
          <tr><td colspan="2"><?php echo tep_draw_form('mail', FILENAME_MAIL, 'action=send_email_to_user'); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
            <td><table border="0" summary="" width="100%" cellpadding="0" cellspacing="2">
              <tr>
...
?>
                <table border="0" summary="" width="100%" cellpadding="0" cellspacing="2">
                  <tr>
...
?>
          <tr><td colspan="2"><?php echo tep_draw_form('mail', FILENAME_MAIL, 'action=preview'); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
            <td><table border="0" summary="" cellpadding="0" cellspacing="2">
              <tr>
