...
?>
      ...
      <tr><td colspan="2"><?php echo tep_draw_form('new_banner', FILENAME_BANNER_MANAGER, (isset($HTTP_GET_VARS['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . 'action=' . $form_action, 'post', 'enctype="multipart/form-data"'); if ($form_action == 'update') echo tep_draw_hidden_field('banners_id', $bID); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
...
?>
              <tr>
                <td colspan="5"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
