...
<!-- body_text //-->
    <td width="100%" valign="top"><?php echo tep_draw_form('password_forgotten', tep_href_link(FILENAME_PASSWORD_FORGOTTEN, 'action=process', 'SSL')); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
      <tr>
        <td><table border="0" summary="" width="100%" style="height: 100%;" cellspacing="1" cellpadding="2" class="infoBox">
