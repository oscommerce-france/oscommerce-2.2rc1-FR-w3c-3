...
?>
            <td width="<?php echo (($sendto != false) ? '70%' : '100%'); ?>" valign="top"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
              <tr>
      ...
      <tr>
        <td><table border="0" summary="" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            ...
            <td width="70%" valign="top" align="right"><table border="0" summary="" cellspacing="0" cellpadding="2">
<?php
