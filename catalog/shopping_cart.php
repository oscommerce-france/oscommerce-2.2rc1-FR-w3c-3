...
<!-- body_text //-->
    <td width="100%" valign="top"><?php echo tep_draw_form('cart_quantity', tep_href_link(FILENAME_SHOPPING_CART, 'action=update_product')); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
// Push all attributes information in an array
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      $products_name = '<table border="0" summary="" cellspacing="2" cellpadding="2">' .
                       '  <tr>' .
