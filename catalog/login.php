...
<!-- body_text //-->
    <td width="100%" valign="top"><?php echo tep_draw_form('login', tep_href_link(FILENAME_LOGIN, 'action=process', 'SSL')); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
      <tr>
        <td><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td width="50%" style="height: 100%;" valign="top"><table border="0" summary="" width="100%" style="height: 100%;" cellspacing="1" cellpadding="2" class="infoBox">
              <tr class="infoBoxContents">
                <td><table border="0" summary="" width="100%" style="height: 100%;" cellspacing="0" cellpadding="2">
                  <tr>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                  </tr>
                  <tr>
