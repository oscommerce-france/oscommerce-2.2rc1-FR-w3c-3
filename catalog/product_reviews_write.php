...
<!-- body_text //-->
    <td width="100%" valign="top"><?php echo tep_draw_form('product_reviews_write', tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, 'action=process&products_id=' . $HTTP_GET_VARS['products_id']), 'post', 'onSubmit="return checkForm();"'); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
      <tr>
      ...
      <tr>
        <td><table summary="" width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td width="<?php echo SMALL_IMAGE_WIDTH + 10; ?>" align="right" valign="top"><table border="0" summary="" cellspacing="0" cellpadding="2">
              <tr>
